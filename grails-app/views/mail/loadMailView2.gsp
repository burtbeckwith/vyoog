<html>    
                        ...
                        <h4 class="panel-title">
                            <a class="collapsed" id="font${it.messageObject}" role="button" onclick="readUpdate('${it.messageObject}','inbox')" data-toggle="collapse" data-parent="#accordion" href="#${it.messageObject}" aria-expanded="false" aria-controls="collapseTwo">
                                ...
                                <div class="col-md-1" style="font-size:11;">
                                    <span style="color: red;cursor: pointer" onclick="deleteMail('inbox','${it.messageObject}')">x</span>
                                </div>
                            </div>
                        </g:if>
                        <g:else>
    ...
    <div id="${it.messageObject}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body" style="font-size: 11">
            ...
            <br/>
            <div class="row">
                <div class="col-md-1">${it.dynamicButton}</div>
                ...
                <div class="col-md-2">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" id="clickMove" aria-expanded="false">ERP Actions<span class="caret"></span></a>
                    <ul class="dropdown-menu">

                        <g:each in="${moreActions}" var="ma">
                            <li><a style="font-size: 12px" href="${ma}" target="_blank">${ma.toString().substring(3,4).toUpperCase()}${ma.toString().substring(4).replace("/listAsGrid","").replace("../","")}</a></li>
                            </g:each>
                ...
                <div class="col-md-1">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="javascript:void(0)" onclick="mailMove('inbox','${it.messageObject}','${folderName}')" style="font-size: 12px">Inbox</a></li>
                            <g:each in="${folder}" var="ff">
                            <li><a style="font-size: 12px" href="javascript:void(0)"  onclick="mailMove('client/${ff.folderName}','${it.messageObject}','${folderName}')"> ${ff.folderName}</a></li>
                            </g:each>
                ...
                <div class="col-md-3" style="#269ABC"><a href="javascript:void(0)" onclick="deleteMail('inbox','${it.messageObject}','inbox')">Delete</a></div>
