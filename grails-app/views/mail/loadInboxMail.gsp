            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="javascript:void(0)" onclick="mailMove('inbox','${it.messageObject}','inbox')" style="font-size: 10">Inbox</a></li>
                            <g:each in="${folder}" var="ff">
                            <li><a href="javascript:void(0)"  onclick="mailMove('client/${ff.folderName}','${it.messageObject}','inbox')"style="font-size: 10"> ${ff.folderName}</a></li>
                            </g:each>
                            <li><center><input type="text" id="newFolderName${it.messageObject}" style="padding-top: 3px;width: 150px;height: 22px" class="form-control input-sm" placeholder="Enter new folder name"></center><br/><span style="padding-left: 6px;padding-top: 6px;"><button type="button"  onclick="mailMove('newFolder','${it.messageObject}','inbox')" class="btn btn-success btn-xs">create</button></span></li>
                    </ul>

                </div>
                <div class="col-md-5" style="#269ABC"><a href="javascript:void(0)" onclick="deleteMail('inbox','${it.messageObject}','inbox')">Delete</a></div>
